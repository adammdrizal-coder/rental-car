...
<body>
    ...
    ?>
        ...
        <div class="text text-white w-1/2 flex justify-center items-center min-h-120">
            <div class="child-text w-90">
            <h1 class="text-5xl font-bold my-5">Flexible Rental Packages</h1>
        ...
        <div class="card-packages max-w-full min-h-screen bg-black text-white flex items-center justify-center">
            ...
            ?>
                ...
                <div class="icon w-full text-center text-xl">
                    ...
                    <div class="text">
                        <h1 class="text-2xl font-semibold text-center my-5">Weekly Rental</h1>
                        ...
                        <h2 class="text-2xl font-semibold my-15 text-center">$149/week</h2>
                        <button class="w-full bg-teal-300 rounded-xl p-2"><a href="#" class="text-black">Choose Package</a></button>
                    </div>
                ...
                <div class="icon w-full text-center text-xl">
                    ...
                    <div class="text">
                        <h1 class="text-2xl font-semibold text-center my-5">Monthly Commuter</h1>
                        <p class="text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. consectetur adipiscing elit.</p>
                        <h2 class="text-2xl font-semibold my-15 text-center">$499/Month</h2>
                        <button class="w-full bg-teal-300 rounded-xl p-2"><a href="#" class="text-black">Choose Package</a></button>
                    </div>
