        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!empty($name) && !empty($email) && !empty($subject) && !empty($message)) {
                ...
                try {
                    ...
                    $mail->SMTPAuth   = true;
                    $mail->Username   = 'adamrizal.dev@gmail.com'; // 🔹 Ganti dengan Gmail admin
                    $mail->Password   = 'bzpu xpyt kqju juag';     // 🔹 Kod 16 huruf dari App Password
                    $mail->SMTPSecure = 'tls';
                    $mail->Port       = 587;
...
<body class="bg-black text-white">
    ...
    <div class="form-contact max-w-full min-h-screen flex flex-col items-center">
        <main class="grid grid-cols-2 grid-rows-3">
            <article class="bg-neutral-800 w-180 p-10 rounded-xl flex flex-col justify-center row-span-3 mx-30">
                ...
                <form action="" method="POST" class="pb-3">
                    ...
                    <input type="text" name="name" placeholder="Your Full Name" class="mt-2 w-full bg-neutral-700 p-2 rounded-xl text-white">
                    
                    <br><br>
                    <label for="email">Email</label><br>
                    <input type="email" name="email" placeholder="you@example.com" class="mt-2 w-full bg-neutral-700 p-2 rounded-xl text-white">
                    
                    <br><br>
                    <label for="subject">Subject</label><br>
                    <input type="text" name="subject" placeholder="Topic of your inquiry" class="mt-2 w-full bg-neutral-700 p-2 rounded-xl text-white">
                    
                    <br><br>
                    <label for="message">Message</label><br>
                    <textarea name="message" cols="30" rows="5" placeholder="Type your message here..." class="mt-2 w-full bg-neutral-700 p-2 rounded-xl text-white"></textarea>
            ...
            <article class="bg-neutral-800 h-40 w-95 p-5 rounded-xl mx-35">
                ...
                <p class="w-90 py-3">For urgent issues, please email us directly.</p>
                <h2 class="text-lg font-semibold">admin@carrental.com</h2>
            </article>
